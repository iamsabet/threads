...
const SignInForm = () => {
  ...
  return (
    <div className="w-full">
      <Form {...form}>
        ...
        >
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="flex flex-col gap-0 w-full">
                <FormLabel className="font-semibold text-[13px] text-light-2 shadow-md mb-0">
                  Email address or username
                </FormLabel>
                <FormControl className="no-focus border border-dark-4 bg-dark-3 text-light-1 rounded-md shadow-md mt-0">
                  <Input
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="flex flex-col gap-0 w-full">
                <FormLabel className="font-semibold text-[13px] text-light-2 shadow-md mb-1.5">
                  Password
                </FormLabel>
                <FormControl className="no-focus border border-dark-4 bg-dark-3 text-light-1 rounded-md shadow-md">
                  <Input
      ...
      <p className="text-gray-2 text-small-regular">
        No account?{" "}
        <Link
          href="/register"
